...
namespace NJson::NTests {
    void check_global() {
...

        {
            ...
            assert(std::holds_alternative<TDouble>(array[1].get_root_value()));
            ...
            assert(std::holds_alternative<TDouble>((*cptr_array)[1].get_root_value()));
    ...
    void test_primitives() {
        ...
        // TInteger
        TJsonValue int_val = 42LL;
        assert(std::holds_alternative<TInteger>(int_val.get_root_value()));

        // TDouble
        TJsonValue double_val = 3.14f;
        assert(std::holds_alternative<TDouble>(double_val.get_root_value()));
    ...
    void test_assignments() {
        ...
        val = 100;
        assert(std::holds_alternative<TInteger>(val.get_root_value()));
